...
The aggregate JSON includes `check_count`, `ready_check_count`, `attention_check_count`, and `attention_checks`; the Markdown repeats those numbers and adds an `Attention Checks` section before the detailed per-check output.
