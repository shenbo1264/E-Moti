...
from guanghe_companion.llm_smoke import run_llm_expression_cue_probes


def _parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run focused LLM expression cue probes.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = run_llm_expression_cue_probes(
        settings,
