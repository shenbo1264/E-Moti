...
class CapabilitySettingsPanel(QWidget):
    ...
    def _build_screen_observation_settings_card(self) -> QGroupBox:
        ...
        self.screen_observation_enabled_check = QCheckBox("授权宠物看屏幕")
        self.screen_observation_auto_check = QCheckBox("授权后自动观察")
    ...
    def _build_web_search_settings_card(self) -> QGroupBox:
        ...
        self.web_search_enabled_check = QCheckBox("授权宠物联网找话题")
        ...
        self.web_search_query_input.setPlaceholderText("手动补充搜索关键词（可选）")
        self.web_search_run_button = QPushButton("手动搜索一次")
    ...
    def _build_proactive_companion_settings_card(self) -> QGroupBox:
        ...
        self.proactive_allow_context_topic_check = QCheckBox("允许基于屏幕/搜索主动找话题")
