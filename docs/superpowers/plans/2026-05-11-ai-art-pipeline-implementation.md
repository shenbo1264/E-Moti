...
角色是原创二次元 Q 版桌面伴侣电子宠物，核心幻想是“可养成、会回应、给疲惫日常补充一抹甜的高情绪价值陪伴”。学习、专注、休息、娱乐只是玩家触发后的动作状态，不是角色基础身份。辅以少量 AI 终端配件。`光核` 是课题/计划语境，不是角色本体设定，也不进入角色命名。
...
服装：简单短外套、小披肩或治愈系轻量科技服饰；可加入一个小型 AI 终端配件，例如耳机、发光胸针或悬浮小终端。学习卡片只在 review 动作状态中作为小道具出现。
